...
{
    Keccak(1088, 512, input, inputByteLen, 0x06, output, 32); //was x06
}

/**
  *  Function to compute SHA3-256 on the input message. The output length is fixed to 32 bytes.
  * (I've changed 0x06 to 0x01)
  */
extern void FIPS202_SHA3_256_01(const unsigned char *input, unsigned int inputByteLen, unsigned char *output)
{
    Keccak(1088, 512, input, inputByteLen, 0x01, output, 32); //was x06
}
